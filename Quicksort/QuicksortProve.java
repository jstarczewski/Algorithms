...
public class Quicksort {
	...
	//    		i indeks konca wystepuje warunkowa instrukcja warunkowa if wychodzaca z rekurencji w
	...
	//    		osiowym zostanie ostatni element i wtedy lo == hi
	//    		void split()
	//		
	...
	//    		
	//    		Pierwasza mniejsza petla dziala dopoki nie znajdziemy (szukajac od lewej) wartosci
	//    		mniejszej niz wartosc osiowa m, gdy jej nie znajdziemy i indeks dojdzie do wartosci
	//    		maksymalnej (hi) to instrukcja warunkowa opuszcza petle
	//	
	//		Druga mniejsza petla dziala analogicznie do pierwszej, petla zostanie opuszczona gdy 
	//		zostanie znaleizona wartosc wieksza niz osiowa, lub w momencie osiagniecia minimalnej
	//		wartosci (lo) przez j, instrukcja warunkowa opuszcza petle
	//		
	...
	//
	//		Obranie elementu osiowego jako najmniejszego(lub najwiekszego) jest zabezpieczone
	//		przez to, ze element osiowy znajduje sie w miejscu a[lo] i nie jest mniejszy niz on sam
	//		Dzieki temu zabezpieczeniu mamy pewnosc ze dla poprawnych danych nie wystapi
	//		wyjscie wskaznikow poza lewy i prawy koniec tablicy
	//
	//	3. Wlasnosc czesciowej poprawnosci
	//		
	//		Tablica wynikowa jest posortowana bo rekurencyjne dzielenie zachodzi do momentu
	//		otrzymania dwuelementowej podtablicy a proces podzialu zawsze umieszcza jeden element
	//		na ostatecznej pozycji, zakladajac poprawna implementacje, jesli lewa i prawa
	...
	//		osiowy) to równiez jest posortowana (tablica wynikowa). 
	//
	//
